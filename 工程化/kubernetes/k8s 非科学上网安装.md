...
>
> `目的`：使用kubeadm搭建一个3台机器组成的k8s集群，1台master节点，2台worker节点
>
...
> 根据安装的Docker方式，在每一台机器上都安装好Docker，版本为18.09.0
...
### 1.7 安装 kubeadm, kubelet and kubectl
...
**记得保存好最后kubeadm join的信息例如：**

```bash
#这是让其他工作节点加入集群的方式
kubeadm join 192.168.199.11:6443 --token 729ppr.py5wbj13scfb05t0 \
    --discovery-token-ca-cert-hash sha256:563459ca818573189503eda9806c50b75dc46fa7bad246d2ef2c3d381b97b907
```
...
```bash
Kubernetes master is running at https://192.168.199.11:6443
KubeDNS is running at https://192.168.199.11:6443/api/v1/namespaces/kube-system/services/kube-dns:dns/proxy
